...
<div class="container">
    ...
    <div>
        ...
        <ul>
            <li><b>resources/training-items.xml</b> - here you can model your items</li>
            <li><b>resources/training-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/training-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/training-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/training-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
